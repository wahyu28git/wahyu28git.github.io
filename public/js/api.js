  ...
  data.teams.forEach(function (tim) {
      ...
      <a href="./detail.html?id=${tim.id}">
        ...
        <div class="card-action right-align">
            <a class="btn-floating btn-large waves-effect waves-light blue" onclick="insertTeamListener(${tim.id})">Add Favorit</a>
        </div>
      </a>  
      </div>
    </div>
  ...
  data.forEach(tim => {
    ...
    <div class="col s12 m6 l6">
      <div class="card">
        ...
        <div class="card-action right-align">
            <a class="btn-floating btn-large waves-effect waves-light red" onclick="deleteTeamListener(${tim.id})">Delete</a>
        </div>
      </div>
    </div>
  `
...
function showTimById(data) {
  document.getElementById('body-content').innerHTML = '<div class="center-align" id="loader"></div>'
  showLoader();
  ...
  const tim = `
    <div class="col s12 m6 l6">
      <div class="card">
        <div class="card-content">
          <div class="center"><img width="300" height="300" src="${data.crestUrl || 'img/empty_badge.svg'}"></div>
